        ...
        <div class="reveal">
          ...
          <div class="mt-6 flex items-center gap-3">
            <a href="{{ route('catalog') }}"
              class="px-5 py-3 rounded-2xl bg-violet-600 hover:bg-violet-500 transition shadow-lg shadow-violet-900/30">Mulai
              Top Up</a>
            <a href="{{ route('catalog') }}"
              class="px-5 py-3 rounded-2xl border border-slate-800/70 hover:border-slate-700 transition">Lihat Harga</a>
          </div>
            ...
            <div class="reveal relative rounded-3xl border border-slate-800/70 bg-[#111826] p-4 shadow-2xl">
              @if($mainHeroProduct)
                ...
                <div class="mt-3 grid sm:grid-cols-2 gap-3">
                  ...
                  @empty
                    {{-- fallback kalau cuma ada 1 produk --}}
                  @endforelse
                </div>
              @else
                {{-- Fallback: kalau belum ada produk di DB, pakai dummy lama --}}
                <div class="flex items-center justify-between p-3 rounded-2xl bg-[#0E1524] border border-slate-800/70">
                  <div class="flex items-center gap-3">
                    <div class="size-9 rounded-xl bg-violet-600/20 grid place-items-center text-violet-300">
                      <svg class="size-5" viewBox="0 0 24 24" fill="none">
                  ...
                  <a href="{{ route('catalog') }}" class="px-3 py-1.5 text-sm rounded-xl bg-violet-600 hover:bg-violet-500">
                    Top Up
                  </a>
                </div>
              @endif
