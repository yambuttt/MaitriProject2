  ...
  <div class="min-h-screen flex">
    ...
    <aside id="dashboardSidebarMobile"
      ...
      <div class="px-5 py-4 border-b border-slate-800 flex items-center justify-between">
        ...
        <button id="dashboardSidebarClose" class="inline-flex items-center justify-center rounded-xl p-2 border border-slate-800/70">
    ...
    <div id="dashboardSidebarOverlay"
         class="fixed inset-0 z-30 bg-black/60 opacity-0 pointer-events-none md:hidden transition-opacity duration-200"></div>
